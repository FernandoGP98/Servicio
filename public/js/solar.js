...
function createscene(){
    ...
    camara.position.set(0, 111200, 111300);
    ...
    /*{
        ...
        var cuadricula = new THREE.GridHelper( 250000, 100, 0x000000, 0x000000 );
        cuadricula.material.opacity = 0.5;
